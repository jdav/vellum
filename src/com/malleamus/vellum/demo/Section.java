...
public class Section implements Registerable {
	...
	public void setState(Persistings ps) throws VellumException {
		...
		for (String rn : rns) {
			...
			Student student1 = (Student) SchoolRegistry.instance().getCopy(srn);
